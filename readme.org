...
| handwired 5-column Corne        | not yet wired up                       |

The three PCBs share one keymap. On the 5-column boards the outer-column switches simply don't
exist, so those bindings are never triggered.
